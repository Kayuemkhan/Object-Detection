  ...
  protected void showResultsInBottomSheet(List<Recognition> results) {
    ...
    if (results != null && results.size() >= 3) {
      ...
      if (recognition != null) {
        ...
        try {
          if (!five && recognitionTextView.getText().toString().equalsIgnoreCase("4 Pepsodent") && confi>80 ) {
            mp2.start();
            five =true;
            ten = false;
            hun = false;
          } else if (!hun&& recognitionTextView.getText().toString().equalsIgnoreCase("0 Harpic")&& confi>99) {
            mp.start();
            hun = true;
            five =false;
            ten = false;
